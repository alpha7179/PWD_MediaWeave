...
**참고:** 현재 구현에서는 Refresh Token이 구현되지 않음

#### 1.3.4. 역할 기반 접근 제어 (RBAC)
...
**Validation Rules:**
- `email`: 필수, @ajou.ac.kr 도메인만 허용, 중복 불가
- `password`: 필수, 최소 8자
- `name`: 필수
...
**Error Response (400 Bad Request) - 도메인 제한:**

```json
{
  "success": false,
  "message": "Only @ajou.ac.kr emails are allowed"
}
```
...
{
  "success": false,
  "message": "Email already currently in use"
}
```
